    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">Kavya Jayasree</h3>
            <p className="text-gray-400 mb-6">
              Tech Explorer | Education Enthusiast | Future Innovator
            </p>
            <p className="text-gray-400">
              Passionate about making a difference through education and technology.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">
              Email: KavyaJayasree@redgmail.com
            </p>
            <p className="text-gray-400 mb-2">
              Phone: +91 901033713
            </p>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500 mb-2">
            © 2025 Kavya Jayasree. All rights reserved.
          </p>
          <p className="text-gray-500 flex items-center justify-center">
            Built with passion and purpose
            <Heart className="h-4 w-4 text-primary-500 mx-1" />
          </p>
        </div>
      </div>
    </footer>
